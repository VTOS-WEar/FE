export default function Footer() {
  return (
    <footer className="relative bg-gradient-to-b from-[#DFCFFF] to-[#3C6EFD] overflow-hidden border-t-3 border-gray-200">
      <div className="max-w-[1100px] mx-auto px-6 lg:px-8 py-16 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-8 mb-12">
          ...
          <div className="text-left">
            <p className="text-sm font-bold uppercase tracking-widest text-gray-900/60 mb-3">Liên hệ</p>
            <p className="text-lg font-extrabold text-gray-900 mb-2">support@vtos.homes</p>
            <p className="text-lg font-extrabold text-gray-900">+84 901 234 567</p>
          </div>

          {/* Center Section */}
          <div className="flex-1 max-w-2xl mx-auto text-center">
            <h3 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-8 leading-normal">
            ...
            <div className="max-w-sm mx-auto">
              <div className="flex items-center gap-1 p-1 bg-white border-3 border-gray-200 rounded-xl shadow-soft-md">
                <input
                  type="email"
                  placeholder="Nhập email của bạn"
                  className="flex-1 px-4 py-2 bg-transparent text-sm font-semibold text-gray-900 placeholder:text-gray-500 outline-none"
                />
                <button className="nb-btn nb-btn-purple h-9 text-sm rounded-lg">
                  Gửi ngay
                </button>
              </div>
              <p className="text-sm font-medium text-gray-900/70 mt-3">
          ...
          {/* Address - Right */}
          <div className="text-left">
            <p className="text-sm font-bold uppercase tracking-widest text-gray-900/60 mb-3">Địa chỉ</p>
            <p className="text-lg font-extrabold text-gray-900">Đà Nẵng</p>
          </div>
        </div>

        {/* Bottom Section */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-8 border-t border-gray-200/15">
          <p className="text-sm font-bold text-gray-900/60">
        ...
        <div className="text-center mt-8">
          <h2
            className="text-[100px] md:text-[160px] lg:text-[220px] font-normal text-gray-900/15 leading-none select-none"
