...
function StatsCard({
    ...
    return (
        ...
        >
            ...
            {indicator && (
                <p className={`[font-family:'Montserrat',Helvetica] font-medium text-xs mt-1.5 ${indicatorColor}`}>
        ...
        <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
                <div className="flex items-center justify-between mb-1">
                    <span className="[font-family:'Montserrat',Helvetica] font-semibold text-[#4C5769] text-sm">{name}</span>
                    <span className="[font-family:'Montserrat',Helvetica] font-bold text-[#1A1A2E] text-sm">{percentage}%</span>
                </div>
                <div className="w-full h-2 bg-[#E5E7EB] rounded-full overflow-hidden">
                    <div
                        className={`h-full rounded-full transition-all duration-700 ${color.replace("bg-", "bg-")}`}
                ...
                <div className="flex-1 flex flex-col min-w-0">
                    ...
                    <div className="bg-white border-b border-[#cbcad7] px-6 lg:px-10 py-5 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="w-9 h-9 rounded-full bg-[#6938EF] flex items-center justify-center cursor-pointer hover:opacity-90 transition-opacity">
                    ...
                    <main className="flex-1 px-4 sm:px-6 lg:px-10 py-6 lg:py-8 space-y-6">
                        ...
                        <div>
                            ...
                            <p className="mt-1 [font-family:'Montserrat',Helvetica] font-medium text-[#4c5769] text-sm lg:text-base">
                                Dưới đây là tình hình đặt đồng phục cho niên khoá <span className="font-bold text-[#6938EF] underline">2025-2026</span>.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
                            ...
                            <div className="lg:col-span-2 bg-white border border-[#CBCAD7] rounded-[16px] p-6">
                                <h2 className="[font-family:'Montserrat',Helvetica] font-bold text-[#1A1A2E] text-lg mb-5">
                                    Phân loại sản phẩm
                                </h2>
