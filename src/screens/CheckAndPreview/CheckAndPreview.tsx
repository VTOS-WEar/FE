                    ...
                    <main className="flex-1 px-4 sm:px-6 lg:px-8 pb-8 space-y-5">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <div className="bg-white rounded-[10px] border border-[#e3e8ef] px-6 py-4">
                                <p className="[font-family:'Montserrat',Helvetica] font-medium text-[#4c5769] text-sm mb-1">
                                    Tổng số dòng tải lên
                                </p>
                                <p className="[font-family:'Montserrat',Helvetica] font-extrabold text-black text-4xl">
                                    {TOTAL_ROWS}
                                </p>
                            </div>
                            ...
                            <div className="bg-[#fff5f5] rounded-[10px] border border-[#ffd5d5] px-6 py-4">
                                <div className="flex items-center gap-1.5 mb-1">
                                    ...
                                    <p className="[font-family:'Montserrat',Helvetica] font-medium text-[#e53e3e] text-sm">
                                        Dòng bị lỗi
                                    </p>
                                </div>
                                <p className="[font-family:'Montserrat',Helvetica] font-extrabold text-[#e53e3e] text-4xl">
                                    {ERROR_COUNT}
                                </p>
                            </div>
                            ...
                            <div className="bg-[#f0fff4] rounded-[10px] border border-[#c6f6d5] px-6 py-4">
                                <div className="flex items-center gap-1.5 mb-1">
                                    ...
                                    <p className="[font-family:'Montserrat',Helvetica] font-medium text-[#38a169] text-sm">
                                        Tỷ lệ thành công
                                    </p>
                                </div>
                                <p className="[font-family:'Montserrat',Helvetica] font-extrabold text-[#38a169] text-4xl">
                                    {SUCCESS_RATE}%
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-3 bg-[#ebf3fd] rounded-[10px] border border-[#c8def9] px-4 py-3">
                            ...
                            <div className="flex items-center gap-2 flex-shrink-0">
                                <Button variant="outline" className="h-9 gap-1.5 border-[#cac9d6] [font-family:'Montserrat',Helvetica] font-semibold text-[#4c5769] text-sm rounded-[8px]">
                        ...
                        <div className="bg-white rounded-[10px] border border-[#e3e8ef] overflow-hidden">
                            ...
                            <div className="grid grid-cols-[2.5rem_1fr_8.75rem_6.25rem_5.625rem_8.75rem_1fr] gap-2 items-center h-12 bg-slate-50 border-b border-[#e3e8ef] px-4">
                                {["#", "HỌ VÀ TÊN", "MÃ HỌC SINH", "LỚP", "GIỚI TÍNH", "SĐT PHỤ HUYNH", "TRẠNG THÁI LỖI"].map((col) => (
                            ...
                            <div className="divide-y divide-[#e3e8ef]">
                                {errorRows.map((row) => (
                                    <div key={row.rowNumber} className="grid grid-cols-[2.5rem_1fr_8.75rem_6.25rem_5.625rem_8.75rem_1fr] gap-2 items-center px-4 py-3">
                                        ...
                                        <span className={`[font-family:'Montserrat',Helvetica] font-semibold text-sm px-2 py-1 rounded-[6px] w-fit ${row.studentIdError ? "bg-[#fff5f5] text-[#e53e3e] border border-[#ffd5d5]" : "text-black"}`}>
                                            {row.studentId}
                                        </span>

                                        <span className={`[font-family:'Montserrat',Helvetica] font-semibold text-sm px-2 py-1 rounded-[6px] w-fit ${row.gradeError ? "bg-[#fff5f5] text-[#e53e3e] border border-[#ffd5d5]" : "text-black"}`}>
                                            {row.grade}
                                        </span>
                                        ...
                                        {row.status.type === "fixed" ? (
                                            <Badge className="w-fit h-auto flex items-center gap-1 bg-[#f0fff4] hover:bg-[#f0fff4] text-[#38a169] border border-[#c6f6d5] rounded-[6px] px-2 py-1">
                                                ...
                                                <span className="[font-family:'Montserrat',Helvetica] font-semibold text-xs">Đã sửa</span>
                                            </Badge>
                                        ) : (
                                            <Badge className="w-fit h-auto flex items-center gap-1 bg-[#fff5f5] hover:bg-[#fff5f5] text-[#e53e3e] border border-[#ffd5d5] rounded-[6px] px-2 py-1">
                                                ...
                                                <span className="[font-family:'Montserrat',Helvetica] font-semibold text-xs whitespace-nowrap">{row.status.message}</span>
                                            </Badge>
                                        )}
                                    </div>
                                ))}
                                ...
                                <div className="flex items-center gap-1">
                                    ...
                                    {[1, 2, 3].map((page) => (
                                        <Button
                                            ...
                                            size="sm"
                                            className={`w-7 h-7 p-0 rounded-[6px] [font-family:'Montserrat',Helvetica] font-bold text-sm ${page === 1 ? "bg-[#3c6efd] hover:bg-[#3c6efd]" : ""}`}
                                        >
                                            {page}
                                        </Button>
                                    ))}
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-3 bg-white rounded-[10px] border border-[#e3e8ef] px-5 py-4">
                            ...
                            <div className="flex items-center gap-2 flex-shrink-0">
                                <Button variant="ghost" className="h-9 [font-family:'Montserrat',Helvetica] font-semibold text-[#4c5769] text-sm rounded-[8px]">
                                    Hủy bỏ
                                </Button>
                                <Button variant="outline" className="h-9 border-[#3c6efd] text-[#3c6efd] hover:bg-[#ebf3fd] [font-family:'Montserrat',Helvetica] font-semibold text-sm rounded-[8px]">
                                    Chỉ nhập {TOTAL_ROWS - ERROR_COUNT} dòng hợp lệ
                                </Button>
                                <Button className="h-9 bg-[#3c6efd] hover:bg-[#3c6efd]/90 [font-family:'Montserrat',Helvetica] font-semibold text-white text-sm rounded-[8px] gap-1.5">
                                    <UploadIcon className="w-4 h-4" />
                                    Lưu &amp; Nhập lại
                                </Button>
                            </div>
