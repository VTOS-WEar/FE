            ...
            <CardContent className="p-0">
              <div className="mb-[29px]">
                <Button className="h-auto px-[15px] py-2.5 rounded-[10px] shadow-[2px_0px_4px_#00000040] bg-[linear-gradient(90deg,rgba(65,130,249,1)_0%,rgba(168,122,240,1)_100%)] hover:opacity-90 transition-opacity">
                  <span className="font-semibold text-white text-base text-center tracking-[0] leading-[normal]">
                    Lịch sử thử đồ
                  </span>
                </Button>
              </div>
              ...
              <div className="flex items-center justify-between mb-[31px]">
                <div className="flex items-center gap-2.5">
                  ...
                  <h2 className="font-bold text-black text-xl tracking-[0] leading-[normal] whitespace-nowrap">
                    Ảnh thử đồ gần đây
                  </h2>
                </div>
                ...
                <div className="flex items-center gap-[7px]">
                  <div className="relative w-60">
                    ...
                    <Input
                      ...
                      className="h-9 pl-[51px] pr-[15px] py-2.5 bg-white rounded-[10px] border border-[#999999] font-medium text-[13px] placeholder:opacity-50"
                    />
                  </div>
                  <img
                    ...
                    <CardContent className="p-0">
                      <div className="relative">
                        ...
                        <div className="absolute top-2 left-[145px] inline-flex items-center justify-center gap-2.5 px-[5px] py-0.5 bg-[#00000080] rounded-[5px]">
                          <span className="font-medium text-white text-[7px] text-center tracking-[0] leading-[normal]">
                            {item.time}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="p-2.5 pt-[17px]">
                        <h3 className="w-[179px] font-semibold text-black text-[15px] tracking-[0] leading-[normal] mb-[9px]">
                          {item.title}
                        </h3>
                        <p className="w-[179px] opacity-[0.69] font-medium text-black text-[10px] tracking-[0] leading-[normal] mb-[31px]">
                          {item.student}
                        </p>
                        <div className="flex items-center justify-between">
                          <span className="font-bold text-[#3c6efd] text-[15px] tracking-[0] leading-[normal] whitespace-nowrap">
                            {item.price}
                          </span>
                          <Button
                            variant="outline"
                          ...
                          >
                            <span className="font-medium text-[#3c6efd] text-[7px] text-center tracking-[0] leading-[normal]">
                              Xem lại
                            </span>
                          </Button>
                        </div>
              ...
              <button className="flex items-center justify-center gap-1 mx-auto transition-opacity hover:opacity-80">
                <span className="opacity-60 font-semibold text-black text-[13px] tracking-[0] leading-[normal]">
