                                ...
                                <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
                                    <div className="max-w-3xl">
                                        ...
                                        <h1 className="mt-4 text-[28px] font-extrabold leading-tight text-gray-900 lg:text-[32px]">
                                            Bảo mật tài khoản trường
                                        </h1>
                                        <p className="mt-2 text-sm font-medium leading-6 text-[#4c5769] lg:text-base">
                                            Tập trung toàn bộ các thao tác nhạy cảm vào một workspace riêng: đổi mật khẩu, kiểm soát xác thực hai bước và rà soát mức độ bảo vệ hiện tại của tài khoản quản trị trường.
                                        </p>
                                    </div>
