          ...
          <Card className="bg-white rounded-[30px] border-0 shadow-none">
            <CardContent className="p-8">
              <div className="flex gap-4 mb-8">
                ...
                <Button
                  variant="ghost"
                  className="h-auto px-[15px] py-2.5 rounded-[10px] shadow-[2px_0px_4px_#00000040] bg-[linear-gradient(90deg,rgba(65,130,249,1)_0%,rgba(168,122,240,1)_100%)] font-semibold text-white text-base hover:opacity-90 transition-opacity"
                >
                  Bảo mật
                </Button>
              </div>
              ...
              <div className="space-y-12">
                <section className="space-y-6">
                  ...
                  <Button className="h-[47px] w-[290px] gap-2.5 px-[15px] py-2.5 bg-[#3c6efd] rounded-[10px] shadow-[0px_0px_8.4px_#3c6efd] font-semibold text-white text-xl hover:bg-[#3c6efd]/90 transition-colors">
