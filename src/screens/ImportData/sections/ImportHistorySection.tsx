                    ...
                    <div key={index}>
                        <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-2.5 w-full">
                            <div className="flex sm:w-[300px] items-center gap-2.5">
                                ...
                                <div className="[font-family:'Montserrat',Helvetica] font-bold text-black text-sm sm:text-[15px] tracking-[0] leading-[normal] break-all sm:whitespace-nowrap">
                                    {item.filename}
                                </div>
                            </div>

                            <div className="flex items-center sm:justify-center sm:w-[200px] [font-family:'Montserrat',Helvetica] font-bold text-[#4c5769] text-sm sm:text-[15px] tracking-[0] leading-[normal]">
                                {item.timestamp}
                            </div>
                            ...
                            <div className="sm:w-[200px]">
                                ...
                                >
                                    ...
                                    />
                                    <span
                                        className={`[font-family:'Montserrat',Helvetica] font-bold ${item.statusTextColor} text-sm sm:text-[15px] text-center tracking-[0] leading-[normal] whitespace-nowrap`}
                                    >
                                        {item.statusText}
                                    </span>
                                </Badge>
