    ...
    return (
        <header className="w-full flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-8">
            <div className="flex flex-col gap-0.5 flex-1">
                <h1 className="font-bold text-black text-2xl sm:text-[32px] tracking-[0] leading-[normal]">
                    Nhập dữ liệu học sinh
                </h1>

                <p className="font-medium text-[#4c5769] text-sm sm:text-base tracking-[0] leading-[normal]">
            ...
            <Button
                variant="outline"
                className="h-auto flex items-center gap-2.5 p-2.5 bg-white rounded-[10px] shadow-[0px_0px_4px_#00000040] font-bold text-black text-sm sm:text-base"
            >
