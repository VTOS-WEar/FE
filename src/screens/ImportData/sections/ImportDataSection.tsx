            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                ...
                <div className="flex-1 space-y-3 sm:space-y-4">
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 flex-wrap">
                        <AlertTitle className="[font-family:'Montserrat',Helvetica] font-bold text-black text-lg sm:text-2xl m-0">
                            Cần cập nhật: Dữ liệu Học kỳ 1 (2026-2027)
                        </AlertTitle>
                        <Badge className="bg-[#f9e3e2] border-[#f6cccb] text-[#ac3129] [font-family:'Montserrat',Helvetica] font-extrabold text-xs sm:text-sm hover:bg-[#f9e3e2] h-auto px-2.5 py-[5px] w-fit">
                            CHƯA NHẬP LIỆU
                        </Badge>
                    </div>

                    <AlertDescription className="[font-family:'Montserrat',Helvetica] font-normal text-sm sm:text-base text-[#364153] leading-normal">
                    ...
                    <div className="inline-flex items-center gap-2.5 p-2.5 bg-[#fcf3cc] rounded-[10px]">
                        ...
                        />
                        <span className="[font-family:'Montserrat',Helvetica] font-semibold text-[#88451d] text-sm sm:text-base">
