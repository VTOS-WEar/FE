        ...
        <aside className="w-full h-full flex flex-col bg-white border-r border-[#cac9d6]">
                    ...
                    <BreadcrumbList className="gap-2.5">
                        {breadcrumbItems.map((item, index) => (
                            <div key={index} className="flex items-center gap-2.5">
                                {index > 0 && (
                                    <BreadcrumbSeparator className="font-semibold text-[#cac9d6] text-base">
                                        /
                                    </BreadcrumbSeparator>
                                )}
                                <BreadcrumbItem>
            ...
            <nav className="flex flex-col px-[25px] mt-[85px] flex-1">
                <div className="flex items-center gap-2.5 px-5">
                    ...
                    <span className="font-semibold text-[#4c5769] text-2xl">
                        Tổng quan
                    </span>
                </div>

                <h2 className="font-bold text-[#97a3b6] text-xl mt-[35px] ml-[9px]">
                    QUẢN LÝ
                </h2>
                ...
                <div className="flex flex-col gap-5 mt-3.5">
                    {managementMenuItems.map((item, index) => (
                        ...
                        >
                            ...
                            <span
                                className={`flex-1 text-left font-semibold text-2xl ${item.isActive ? "text-[#478aea]" : "text-[#4c5769]"
                                    }`}
                            >
                                {item.label}
                            </span>
                ...
                >
                    <span className="font-semibold text-[#ff0000] text-2xl text-center">
                        Đăng xuất
                    </span>
                    <img className="w-[30px] h-[30px]" alt="Material symbols" />
                </Button>
