...
export function HeroSection() {
  return (
    <section className="relative w-full overflow-hidden  py-10">
      ...
      <div className="mx-auto grid max-w-[1000px] grid-cols-1 items-center px-6 md:grid-cols-2">
        ...
        <div className="space-y-4 text-center mt-8">
          ...
          <h2 className="[font-family:'Baloo_2',Helvetica] text-3xl font-semibold leading-[1.2] text-[#342724]">
            Thử đồng phục trực tuyến bằng AI
          </h2>

          <p className="mx-auto max-w-[760px] [font-family:'Baloo_2',Helvetica] text-md leading-[1.45] text-[#4a403e] font-medium">
            ...
            >
              <Button
                className="
                  ...
                  shadow-[0_0_0_1px_rgba(168,85,247,0.3),0_8px_24px_rgba(139,92,246,0.5),0_16px_60px_rgba(168,85,247,0.45),0_24px_80px_rgba(192,132,252,0.3)]
                  hover:shadow-[0_0_0_1px_rgba(168,85,247,0.4),0_10px_28px_rgba(139,92,246,0.6),0_20px_70px_rgba(168,85,247,0.55),0_30px_90px_rgba(192,132,252,0.35)]
                "
              >
                {/* Glow background */}
                <span
