        ...
        <div className="container mx-auto px-4 py-3">
          <nav className="flex items-center justify-between gap-3">
            ...
            <div className="hidden lg:flex items-center gap-8 px-8 py-3 bg-white rounded-full shadow-lg">
              <a href="#" className="font-baloo font-semibold text-base text-black hover:text-purple-dark transition-colors">
                Trang chủ
              </a>
              <a href="#how-it-works" className="font-baloo font-semibold text-base text-black hover:text-purple-dark transition-colors">
                Cách hoạt động
              </a>
              <a href="/schools" className="font-baloo font-semibold text-base text-black hover:text-purple-dark transition-colors">
                Tìm trường
              </a>
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <span className="hidden md:inline font-baloo font-semibold text-base text-black truncate max-w-[160px]">{profileButtonLabel}</span>
