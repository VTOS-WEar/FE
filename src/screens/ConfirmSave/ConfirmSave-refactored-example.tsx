/**
 * ❌ BEFORE - Code lặp lại, 245 dòng
 *
 * - Quản lý isCollapsed state
 * - Layout boilerplate (sidebar + footer)
 * - Cấu trúc div lặp lại
 *
 * ✅ AFTER - Code sạch, chỉ 150 dòng (tiết kiệm ~40%)
 *
 * - DashboardLayout tự động xử lý sidebar + footer
 * - Chỉ focus vào content
 * - Dễ thay đổi layout toàn bộ ứng dụng
 */
            ...
            <main className="flex-1 px-4 sm:px-6 lg:px-8 pb-8 space-y-5">
                ...
                <div className="bg-white rounded-[0.625rem] border border-[#e3e8ef] overflow-hidden">
                    ...
                    <div className="grid grid-cols-[2rem_1fr_4rem_4rem_4rem_5rem_6rem] gap-2 items-center h-12 bg-slate-50 border-b border-[#e3e8ef] px-4">
                        {["STT", "MÃ HS", "HỌ VÀ TÊN", "LỚP", "GIỚI TÍNH", "NGÀY SINH", "SĐT PHỤ HUYNH"].map((col) => (
