                ...
                <div className="mx-auto w-full max-w-6xl">
                    <div className="nb-card-static overflow-hidden rounded-2xl">
                        <div className="flex flex-col lg:flex-row">
                            ...
                            {/* RIGHT — Hero with NB */}
                            <div className="lg:w-[48%] relative overflow-hidden bg-[#A8D4E6] p-8 lg:p-12 flex items-center justify-center border-l-0 lg:border-l-2 border-t-2 lg:border-t-0 border-gray-200">
                                {/* Decorative NB shapes */}
                                <div className="absolute top-8 left-8 w-14 h-14 bg-amber-400 border border-gray-200 rounded-lg shadow-soft-sm rotate-12 opacity-60" />
                                <div className="absolute bottom-16 left-6 w-10 h-10 bg-purple-400 border border-gray-200 rounded-full shadow-soft-sm opacity-50" />
                                <div className="absolute top-[35%] right-8 w-12 h-12 bg-emerald-400 border border-gray-200 rounded-lg shadow-sm -rotate-6 opacity-60" />
